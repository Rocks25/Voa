...
void Ship::Render()
{
	...
	Plane::Render(-50/2.0f,-50/2.0f,(float)50,(float)50);
...
{
	TM->AddTexture("images/Ship/Spaceship_Final.jpg", "Ship");
	TM->AddTexture("images/Ship/Spaceship_Final_Alpha.jpg", "Ship_Alpha");
}
